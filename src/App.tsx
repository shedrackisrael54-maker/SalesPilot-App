...
function ProductForm({ product, onSave, onDelete, onCancel, externalError }: { product: Product | null; onSave: (p: Product) => void; onDelete?: (id: string) => Promise<void>; onCancel: () => void; externalError?: string }) {
  const { user } = useAuth();
...
function ProductsScreen() {
  ...
  if (view === 'edit' && editing) {
    return <ProductForm product={editing} onSave={handleSave} onDelete={handleDelete} onCancel={() => { setView('list'); setEditing(null); }} externalError={saveError} />;
  }
