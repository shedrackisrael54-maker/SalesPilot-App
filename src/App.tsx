...
// that could break. The `e_make_transparent` transformation is applied by Cloudinary itself,
// which genuinely strips the solid white background out of the image file rather than trying to
// hide it with CSS - CSS blending only works if the background is pure white, and most exported
// graphics are very slightly off-white, which is what leaves a visible box behind.
const SPLASH_GRAPHIC_URL = 'https://res.cloudinary.com/xd2hkwf8/image/upload/e_make_transparent:40/v1786216032/file_000000009728820ca7a1c61dbadc5015_eppnpd.png';
