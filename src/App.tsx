...
const PLANS = [
  ...
  { id: 'pro', name: 'Growth', desc: 'Built for growing businesses', prices: { quarterly: 15000, biannual: 27500, annual: 50000 }, features: ['Everything included in Starter', 'Staff accounts with role based permissions', 'Customer segments and groups', 'Email and SMS marketing campaigns', 'Sales by Marketing Channel analytics', 'Website visit tracking', 'Facebook Pixel and Google Analytics integration', 'Full access to all 32 brand themes', 'Free custom domain with annual billing', 'Priority customer support'], popular: true },
];
...
const PLAN_FEATURE_GROUPS: { heading: string; items: { text: string; starter: boolean; growth: boolean }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Email marketing campaigns', starter: false, growth: true },
      { text: 'SMS campaigns', starter: false, growth: true },
    ],
  },
];
...
function SubscriptionScreen({ onBack }: { onBack: () => void }) {
  ...
  const handlePay = () => {
    ...
    const amount = activePlan.prices[billing];
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: 'Inter, sans-serif', paddingBottom: 40 }}>
      ...
      <div style={{ padding: 20 }}>
        ...
        >
          {processing ? 'Processing...' : `Pay ${NAIRA}${activePlan.prices[billing].toLocaleString()} with Paystack`}
        </button>
      </div>
    </div>
  );
