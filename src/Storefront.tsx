...
import { NAIRA, THEME_NICHES, ProductIcon, isValidCSSColor, isColorOptionGroup, getTieredPrice, NIGERIAN_STATES, getOptimizedImageUrl, PLATFORM_LOGO_URL } from './shared';
                ...
                <div style={{ background: '#F9FAFB', border: '1px solid #E5E7EB', borderRadius: 14, padding: 16, marginBottom: 14 }}>
                  ...
                  <div style={{ marginBottom: 10 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      ...
                      <button
                        onClick={() => { navigator.clipboard.writeText(merchant.accountNumber!); setCopiedAccount(true); setTimeout(() => setCopiedAccount(false), 2000); }}
