...
function StoreFooter({ merchant, theme, slug }: { merchant: MerchantInfo; theme: StoreTheme; slug: string }) {
  return (
    <div id="sp-contact" style={{ background: theme.secondary, padding: '28px 20px calc(24px + 110px + env(safe-area-inset-bottom))', transition: 'background 0.5s ease' }}>
...
export function StorefrontScreen() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: theme.background, fontFamily: 'Inter, sans-serif', transition: 'background 0.5s ease', overflowX: 'hidden' as const, width: '100%', maxWidth: '100vw', boxSizing: 'border-box' as const, paddingBottom: 40 }}>
      <style>{`
...
export function ProductDetailScreen() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: theme.background, fontFamily: 'Inter, sans-serif', transition: 'background 0.5s ease', overflowX: 'hidden' as const, paddingBottom: 40 }}>
