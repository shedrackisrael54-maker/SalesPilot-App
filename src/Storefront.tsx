...
export function StorefrontScreen() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: theme.background, fontFamily: 'Inter, sans-serif', transition: 'background 0.5s ease', overflowX: 'hidden' as const, width: '100%', maxWidth: '100vw', boxSizing: 'border-box' as const, paddingBottom: 84 }}>
      <style>{`
      ...
      {!showWishlist && (
        <>
          ...
          {/* Discover More - full-width squared strip, matching the trust badge treatment used
              elsewhere on the page rather than another rounded card. */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, width: '100%', borderRadius: 0, background: theme.secondary, padding: '18px 16px', marginBottom: 22, transition: 'background 0.6s ease' }}>
            <div style={{ width: 38, height: 38, borderRadius: '50%', border: `1.5px solid ${theme.accent}`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <ShoppingBag size={17} color={theme.accent} />
            </div>
            <p style={{ flex: 1, color: '#fff', fontSize: 13.5, fontWeight: 800, lineHeight: 1.3 }}>
              Discover More <span style={{ color: theme.accent }}>with {merchant.storeName || 'us'}</span>
            </p>
            <button
              className="sp-btn"
              onClick={() => { setActiveCategory(null); setSearch(''); document.getElementById('sp-products')?.scrollIntoView({ behavior: 'smooth' }); }}
              style={{ display: 'inline-flex', alignItems: 'center', gap: 5, background: theme.accent, color: theme.secondary, border: 'none', borderRadius: 9, padding: '9px 14px', fontSize: 11.5, fontWeight: 800, cursor: 'pointer', whiteSpace: 'nowrap' as const, flexShrink: 0, transition: 'transform 0.15s ease' }}
            >
...
export function ProductDetailScreen() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: theme.background, fontFamily: 'Inter, sans-serif', transition: 'background 0.5s ease', overflowX: 'hidden' as const, paddingBottom: 84 }}>
