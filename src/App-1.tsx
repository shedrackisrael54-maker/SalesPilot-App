      ...
      <div style={{ position: 'relative' as const, display: 'flex', flexDirection: 'column' as const, alignItems: 'center', padding: '0 32px' }}>
        <div style={{ animation: 'sp-graphic-in 1s cubic-bezier(0.22, 1, 0.36, 1) forwards', position: 'relative' as const }}>
          <img
            ...
            alt="SalesPilot"
            style={{ width: 'min(72vw, 300px)', height: 'auto', display: 'block', objectFit: 'contain' as const }}
          />
        </div>
        ...
        <div style={{
          ...
          marginTop: 26, display: 'flex', flexDirection: 'column' as const, alignItems: 'center',
        }}>
          <span style={{ fontSize: 30, fontWeight: 800, color: C.navy, letterSpacing: -0.3 }}>SalesPilot</span>
          <div style={{ width: 34, height: 2.5, borderRadius: 2, background: C.green, margin: '12px 0 11px' }} />
          <span style={{ fontSize: 13, color: C.gray, letterSpacing: 0.4, fontWeight: 500 }}>Your business, in your pocket</span>
        </div>
      </div>
