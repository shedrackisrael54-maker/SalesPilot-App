...
import { NAIRA, THEME_NICHES, PRODUCT_CATEGORIES, PRODUCT_ICON_MAP, PRODUCT_ICON_KEYS, ProductIcon, compressImage, uploadToCloudinary, isValidCSSColor, isColorOptionGroup, NIGERIAN_STATES } from './shared';
...
// A merchant has "Pro access" if they're actually on the Pro plan, OR if they're still within
// their 14-day free trial (the trial gives full access to every feature regardless of which
// plan they picked at signup, so they can properly evaluate Pro before choosing a plan).
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div style={{ position: 'relative' as const }}>
              <button style={{ background: 'rgba(255,255,255,0.1)', border: 'none', borderRadius: 10, width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
                <Bell size={20} color="white" />
              </button>
              <div style={{ position: 'absolute' as const, top: -4, right: -4, background: C.orange, borderRadius: '50%', width: 18, height: 18, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 700, color: 'white' }}>3</div>
            </div>
          </div>
        </div>
      </div>
