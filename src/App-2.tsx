  ...
  if (activeInfoCard) {
    ...
    return (
      <div style={{ background: C.bg, minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
        <div style={{ background: gradient, padding: '20px 20px 28px', position: 'relative' as const }}>
        ...
        <div style={{ background: C.white, borderRadius: '24px 24px 0 0', marginTop: -16, padding: 20, paddingBottom: 60 }}>
