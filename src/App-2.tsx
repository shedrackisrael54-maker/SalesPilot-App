  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'relative' as const, display: 'flex', flexDirection: 'column' as const, alignItems: 'center', padding: '0 32px' }}>
        <div style={{ animation: 'sp-graphic-in 1s cubic-bezier(0.22, 1, 0.36, 1) forwards', position: 'relative' as const }}>
          <img
            src={SPLASH_GRAPHIC_URL}
            alt="SalesPilot"
            style={{
              width: 'min(52vw, 210px)', height: 'auto', display: 'block', objectFit: 'contain' as const,
              // The graphic file carries its own solid white background, which otherwise shows as
              // a visible box against the page. Multiply blending drops pure white to nothing, so
              // the artwork sits directly on the background with no edge at all.
